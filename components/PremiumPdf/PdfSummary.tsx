...
/*
 * Recherche une planète par son nom anglais.
 */
function getPlanet(
...
/*
 * Récupère le signe d’une planète.
 */
function getPlanetSign(
  ...
  return translateSign(planet.sign);
}

/*
 * Convertit une valeur inconnue en objet.
 */
function asRecord(
  value: unknown
...
/*
 * Essaie de récupérer un signe depuis différentes structures
 * possibles de l’Ascendant.
 */
...
/*
 * Recherche le signe de l’Ascendant dans plusieurs formats
 * possibles transmis par l’API astrologique.
 */
