export type PremiumPlanetChallenges = Record<
  string,
  Record<string, string[]>
>;

export const PREMIUM_PLANET_CHALLENGES: PremiumPlanetChallenges = {
  Sun: {
    Aries: [
      "Impulsivité",
      "Manque de patience",
...
export function getPremiumPlanetChallenges(
  planet: string,
  sign: string
): string[] {
  const planetChallenges =
    PREMIUM_PLANET_CHALLENGES[
      planet
    ];
