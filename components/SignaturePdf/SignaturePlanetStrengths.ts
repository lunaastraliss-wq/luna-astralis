export type SignaturePlanetStrengths = Record<
  string,
  Record<string, string[]>
>;

export const SIGNATURE_PLANET_STRENGTHS: SignaturePlanetStrengths = {
  Sun: {
    Aries: [
...
export function getSignaturePlanetStrengths(
  planet: string,
  sign: string
): string[] {
  const planetStrengths =
    SIGNATURE_PLANET_STRENGTHS[planet];
