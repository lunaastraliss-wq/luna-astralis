...
import { MAIN_PLANETS } from "./SignaturePdfUtils";
...
export default function PdfSignatureModalities({
  planets,
}: SignaturePdfPlanetsProps) {
  const safePlanets =
  ...
  Elles révèlent la manière dont vous initiez les expériences,
  développez vos projets et vous adaptez aux changements
  ...
  Les modalités ne décrivent pas seulement votre manière d’agir.
  Elles révèlent le rythme naturel de votre évolution et la façon
  dont vous abordez chaque étape de votre parcours. Leur interaction
  avec vos planètes et vos maisons enrichit la lecture globale de
  votre thème natal.
</Text>
      </View>
