...
function normalizeZodiacSign(
  ...
  const zodiacSignAliases:
    Record<string, YearlyMantraZodiacSign> = {
      belier: "belier",
      aries: "belier",
      taureau: "taureau",
      taurus: "taureau",
...
/*
|--------------------------------------------------------------------------
| Banque de textes — mantra de l’année
|--------------------------------------------------------------------------
|
...
const YEARLY_MANTRA_TEXTS:
  Record<YearlyMantraZodiacSign, YearlyMantraTexts> = {
  /*
  |--------------------------------------------------------------------------
  | Bélier
  |--------------------------------------------------------------------------
...
export function createYearlyMantraTexts(
  zodiacSign: string,
): YearlyMantraTexts {
  const normalizedSign = normalizeZodiacSign(zodiacSign);

  return YEARLY_MANTRA_TEXTS[normalizedSign];
}
