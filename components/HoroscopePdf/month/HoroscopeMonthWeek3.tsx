...
export type HoroscopeMonthWeek3Content = {
  title: string;
  dateLabel: string;
  introduction: string;
  text: string;
...
type HoroscopeMonthWeek3Props = Pick<
  HoroscopeSectionProps,
  "identity" | "period"
> & {
  week: HoroscopeMonthWeek3Content;
};
...
export default function HoroscopeMonthWeek3({
  identity,
  period,
  week,
}: HoroscopeMonthWeek3Props) {
