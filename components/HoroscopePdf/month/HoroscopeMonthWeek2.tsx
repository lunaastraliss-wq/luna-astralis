...
export type HoroscopeMonthWeek2Content = {
  title: string;
  dateLabel: string;
  introduction: string;
  text: string;
...
type HoroscopeMonthWeek2Props = Pick<
  HoroscopeSectionProps,
  "identity" | "period"
> & {
  week: HoroscopeMonthWeek2Content;
};
...
export default function HoroscopeMonthWeek2({
  identity,
  period,
  week,
}: HoroscopeMonthWeek2Props) {
