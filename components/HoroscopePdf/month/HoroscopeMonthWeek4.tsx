...
export type HoroscopeMonthWeek4Content = {
  title: string;
  dateLabel: string;
  introduction: string;
  text: string;
...
type HoroscopeMonthWeek4Props = Pick<
  HoroscopeSectionProps,
  "identity" | "period"
> & {
  week: HoroscopeMonthWeek4Content;
};
...
export default function HoroscopeMonthWeek4({
  identity,
  period,
  week,
}: HoroscopeMonthWeek4Props) {
