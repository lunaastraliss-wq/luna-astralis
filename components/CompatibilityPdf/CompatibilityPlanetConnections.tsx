    ...
    <PageFrame page={definition.page}>
      ...
      >
        ...
        <View style={styles.iconRow}>
          ...
          <View
            style={styles.connectionFrame}
          >
            <View
              style={
                styles.connectionIconFrame
              }
            >
              <Image
                src={LOGO_URL}
      ...
      >
        ...
        >
          ...
          <Text
            style={styles.adviceText}
          >
            Aucune connexion ne définit seule
            votre relation. La compatibilité se
            construit dans l’équilibre entre
            identité, sécurité émotionnelle,
            affection, communication et désir.
            Vos différences ne représentent pas
            nécessairement des obstacles : elles
            indiquent souvent les endroits précis
            où le couple apprend à mieux se
            connaître et à évoluer.
          </Text>
        </View>
      </View>
    </PageFrame>
