...
const LIFE_PAGES: LifeDefinition[] = [
  {
    ...
    keywords: ["moon", "lune", "saturn", "saturne", "mercury", "mercure"],
  },
  {
    page: 38,
    ...
    keywords: ["moon", "lune", "venus", "saturn", "saturne"],
  },
  {
    page: 39,
    ...
    keywords: ["mercury", "mercure", "moon", "lune", "saturn", "saturne"],
  },
  {
    page: 40,
    ...
    keywords: ["venus", "mars", "moon", "lune", "pluto", "pluton"],
  },
  {
    page: 41,
    ...
    keywords: ["venus", "saturn", "saturne", "jupiter", "mercury", "mercure"],
  },
  {
    page: 42,
    ...
    keywords: ["sun", "soleil", "jupiter", "saturn", "saturne", "mars"],
  },
  {
    page: 43,
    ...
    keywords: ["jupiter", "saturn", "saturne", "sun", "soleil", "mars"],
  },
  {
    page: 44,
    ...
    keywords: ["saturn", "saturne", "jupiter", "uranus", "pluto", "pluton"],
  },
];
...
function getPersonalStyle(
  ...
  const elementMap: Record<string, string> = {
    belier: "spontané et direct",
    taureau: "stable et concret",
    gemeaux: "souple et curieux",
    cancer: "protecteur et sensible",
    lion: "chaleureux et affirmé",
    vierge: "méthodique et pratique",
    balance: "coopératif et diplomate",
    scorpion: "profond et intense",
    sagittaire: "enthousiaste et expansif",
    capricorne: "responsable et structuré",
    verseau: "indépendant et original",
    poissons: "intuitif et réceptif",
  };
...
function LifePage({
  ...
  const relevantAspects = getRelevantAspects(
    aspects,
    definition.keywords,
  );
      ...
      {relevantAspects.length > 0 && (
        <View wrap={false}>
          ...
          {relevantAspects.map(
            (aspect, index) => (
              <AspectCard
                key={`${definition.page}-${index}-${aspect.person1Planet}-${aspect.person2Planet}`}
                aspect={aspect}
              />
            ),
          )}
