...
} from "@/i18n/pages/carte-du-ciel/signature";
...
export function generateMetadata({
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        fr:
          `${SITE_URL}/fr/carte-du-ciel/signature`,

        en:
          `${SITE_URL}/en/carte-du-ciel/signature`,

        es:
          `${SITE_URL}/es/carte-du-ciel/signature`,

        de:
          `${SITE_URL}/de/carte-du-ciel/signature`,

        it:
          `${SITE_URL}/it/carte-du-ciel/signature`,

        pt:
          `${SITE_URL}/pt/carte-du-ciel/signature`,
