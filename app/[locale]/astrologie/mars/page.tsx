// app/[locale]/astrologie/mars/page.tsx
...
import {
  MARS_TRANSLATIONS,
} from "@/i18n/pages/astrologie/mars";

import "../../../astrologie/mars/page.css";
...
export function generateMetadata({
  ...
  const pageUrl =
    `${SITE_URL}/${locale}/astrologie/mars`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        fr:
          `${SITE_URL}/fr/astrologie/mars`,

        en:
          `${SITE_URL}/en/astrologie/mars`,

        es:
          `${SITE_URL}/es/astrologie/mars`,

        de:
          `${SITE_URL}/de/astrologie/mars`,

        it:
          `${SITE_URL}/it/astrologie/mars`,

        pt:
          `${SITE_URL}/pt/astrologie/mars`,
        ...
        <article className="mars-content">
          ...
          <section>
            ...
            <div className="mars-info-grid">
              {text.action.cards.map(
                (card) => (
                  <div
                    className="mars-info-card"
                    key={
                      card.title
                    }
                  >
