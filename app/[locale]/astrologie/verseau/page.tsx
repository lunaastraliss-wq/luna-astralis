// app/[locale]/astrologie/verseau/page.tsx
...
import {
  VERSEAU_TRANSLATIONS,
} from "@/i18n/pages/astrologie/verseau";

import "../../../astrologie/verseau/page.css";
...
export function generateMetadata({
  ...
  const pageUrl =
    `${SITE_URL}/${locale}/astrologie/verseau`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        fr:
          `${SITE_URL}/fr/astrologie/verseau`,

        en:
          `${SITE_URL}/en/astrologie/verseau`,

        es:
          `${SITE_URL}/es/astrologie/verseau`,

        de:
          `${SITE_URL}/de/astrologie/verseau`,

        it:
          `${SITE_URL}/it/astrologie/verseau`,

        pt:
          `${SITE_URL}/pt/astrologie/verseau`,
            ...
            <div className="aquarius-pillars">
              {
                foundationCards.map(
                  (
                    ...
                    <div
                      className="aquarius-pillar-card"
                      key={
                        item.title
                      }
                    >
