// app/[locale]/astrologie/poissons/page.tsx
...
import {
  POISSONS_TRANSLATIONS,
} from "@/i18n/pages/astrologie/poissons";

import "../../../astrologie/poissons/page.css";
...
export function generateMetadata({
  ...
  const pageUrl =
    `${SITE_URL}/${locale}/astrologie/poissons`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        fr:
          `${SITE_URL}/fr/astrologie/poissons`,

        en:
          `${SITE_URL}/en/astrologie/poissons`,

        es:
          `${SITE_URL}/es/astrologie/poissons`,

        de:
          `${SITE_URL}/de/astrologie/poissons`,

        it:
          `${SITE_URL}/it/astrologie/poissons`,

        pt:
          `${SITE_URL}/pt/astrologie/poissons`,
