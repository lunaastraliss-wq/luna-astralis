...
const TEXT: Record<NonFrenchLocale, Record<string, string>> = {
  "en": {
    ...
    "La réussite, le temps consacré au travail ou les différences d’ambition peuvent créer de la distance ou de la comparaison.": "Success, time devoted to work, or differences in ambition can create distance or comparison.",
  ...
  "es": {
    ...
    "La réussite, le temps consacré au travail ou les différences d’ambition peuvent créer de la distance ou de la comparaison.": "El éxito, el tiempo dedicado al trabajo o las diferencias de ambición pueden crear distancia o comparación.",
  ...
  "de": {
    ...
    "La réussite, le temps consacré au travail ou les différences d’ambition peuvent créer de la distance ou de la comparaison.": "Erfolg, Arbeitszeit oder unterschiedliche Ambitionen können Distanz oder Vergleiche erzeugen.",
  ...
  "it": {
    ...
    "La réussite, le temps consacré au travail ou les différences d’ambition peuvent créer de la distance ou de la comparaison.": "Il successo, il tempo dedicato al lavoro o le differenze di ambizione possono creare distanza o confronto.",
  ...
  "pt": {
    ...
    "La réussite, le temps consacré au travail ou les différences d’ambition peuvent créer de la distance ou de la comparaison.": "O sucesso, o tempo dedicado ao trabalho ou diferenças de ambição podem criar distância ou comparação.",
