...
export function localizeCompatibilityFile({
   ...
   */
  if (
    fileName === "CompatibilityScores.tsx"
  ) {
   ...
   */
  if (
    fileName === "CompatibilityPillars.tsx"
  ) {
   ...
   */
  if (
    fileName === "CompatibilityEmotional.tsx"
  ) {
  ...
  /*
   * Pages 9 à 12 — Amour,
   * désir, chimie et intimité.
   */
  if (
    fileName === "CompatibilityLove.tsx"
  ) {
   ...
   */
  if (
    fileName === "CompatibilityCouple.tsx"
  ) {
  ...
  /*
   * Pages 17 à 21 —
   * planètes relationnelles.
   */
  if (
    fileName === "CompatibilityPlanets.tsx"
  ) {
   ...
   */
  if (
    fileName === "CompatibilityAspects.tsx"
  ) {
   ...
   */
  if (
    fileName === "CompatibilityLife.tsx"
  ) {
   ...
   */
  if (
    fileName === "CompatibilitySummary.tsx"
  ) {
