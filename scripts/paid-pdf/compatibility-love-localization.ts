...
> = {
  en: {
    ...
    /*
     * IMPORTANT :
     * "de" et "en" sont permis ici,
     * car le nouveau moteur traduit
     * uniquement des noeuds AST.
     * Il ne touche jamais au mot
     * TypeScript "default".
     */
    "de":
      "of",
  ...
  /*
   * Les quatre dictionnaires ci-dessous
   * restent exactement comme dans ton
   * fichier actuel pour le moment.
   *
   * Ils ne provoquent pas le build error.
   */
  es: {},
  de: {},
  it: {},
...
function localizeSafeLiterals(
  ...
  const visit = (
     ...
     * entre des balises JSX.
     *
     * Exemple :
     *
     * <Text>Vénus</Text>
     *
     * Ici on remplace uniquement
     * CE texte.
     *
     * On ne touche jamais aux mots
     * du code TypeScript.
     */
    if (
      ts.isJsxText(node)
    ...
    /*
     * String literal TypeScript.
     *
     * Exemple :
     *
     * return "Énergie fluide";
     *
     * On peut traduire la chaîne,
     * mais jamais le code autour.
     */
    if (
