...
const PLANETS_DYNAMIC_TEXT: Record<NonFrenchLocale, Record<string, string>> = {
  ...
  "es": {
    ...
    "Le besoin de liberté peut provoquer de la distance ou de l’imprévisibilité si les changements surviennent sans explication ni repère rassurant.": "La necesidad de libertad puede crear distancia o imprevisibilidad si los cambios ocurren sin explicación ni referencias tranquilizadoras.",
  ...
  "de": {
    ...
    "Le besoin de liberté peut provoquer de la distance ou de l’imprévisibilité si les changements surviennent sans explication ni repère rassurant.": "Das Freiheitsbedürfnis kann Distanz oder Unberechenbarkeit erzeugen, wenn Veränderungen ohne Erklärung oder beruhigende Orientierung erfolgen.",
  ...
  "it": {
    ...
    "Le besoin de liberté peut provoquer de la distance ou de l’imprévisibilité si les changements surviennent sans explication ni repère rassurant.": "Il bisogno di libertà può creare distanza o imprevedibilità se i cambiamenti avvengono senza spiegazioni o punti di riferimento rassicuranti.",
  ...
  "pt": {
    ...
    "Le besoin de liberté peut provoquer de la distance ou de l’imprévisibilité si les changements surviennent sans explication ni repère rassurant.": "A necessidade de liberdade pode criar distância ou imprevisibilidade se as mudanças ocorrerem sem explicação ou referências tranquilizadoras.",
